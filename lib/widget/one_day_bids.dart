...
class OneDayBids extends StatefulWidget {
  ...
  OneDayBids({Key key, @required this.routeData}) : super(key: key);
  @override
  ...
  _getWalletAmount() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await prefs.setString('walletAmount', '40000');
      } else if (response.statusCode == 408) {
        AutoLogOut().popUpFor408(context);
      } else {
        final eData = jsonDecode(response.body);
  ...
  Widget build(BuildContext context) {
    ...
    _edit( context) async {
      ...
      await Navigator.of(context)
          .pushNamed(PlayNumber.routeName,)
          //  arguments: _games[index].type)
          .then((value) {
        final Map<String, dynamic> data = value;
